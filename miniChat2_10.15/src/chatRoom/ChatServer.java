...
import chatRoom.ChatServerWatchService;
...
public class ChatServer {
	...
	public void removeSocketClient(SocketClient socketClient) throws IOException {
		String key = socketClient.chatName + "@" + socketClient.clientIp;
		chatRoom.remove(key);
	...
	public static void main(String[] args) {	
		try {
			...
			String path = "C:\\Users\\user\\eclipse-workspace\\miniChat2\\bin\\chatRoom";
